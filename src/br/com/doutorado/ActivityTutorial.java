...
public class ActivityTutorial extends Activity implements OnTouchListener {
    ...
    protected void onResume() {
        ...
        dialog.setMessage(R.string.mostrar_novamente_tutorial_texto);
        ...
        dialog.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (checkBox.isChecked()) {
                	...
                	editor.putString(Utils.PREF_TUTORIAL, "not_show_again");
                	editor.commit();
                }
        ...
        if (settings.getString(Utils.PREF_TUTORIAL, "").equals("")) {
        	dialog.show();
        }
